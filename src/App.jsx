...
import { AppProvider } from "@/context/Context"; // ← исправлено
        ...
        <BrowserRouter>
          <Routes>
            <Route path="/">
              ...
              <Route path="courses-single-3/:id" element={<CourseSinglePage3 />} />
              <Route path="courses-single-4/:id" element={<CourseSinglePage4 />} />
              <Route path="courses-single-5/:id" element={<CourseSinglePage5 />} />
              ...
              <Route path="instructors-list-1" element={<InstractorListPage1 />} />
              <Route path="instructors-list-2" element={<InstractorListPage2 />} />
              <Route path="instructors/:id" element={<InstractorSinglePage />} />
              <Route path="instructor-become" element={<InstractoBacomePage />} />
